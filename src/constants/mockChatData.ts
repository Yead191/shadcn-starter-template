...
export const mockUsers = {
  user_1: { _id: "user_1", name: "Alice Johnson", image: "/user.png", status: "active" },
  user_2: { _id: "user_2", name: "Bob Smith", image: "/user.png", status: "active" },
  user_3: { _id: "user_3", name: "Charlie Brown", image: "/user.png", status: "active" },
  user_4: { _id: "user_4", name: "Diana Prince", image: "/user.png", status: "active" }
};
